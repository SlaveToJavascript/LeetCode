...
# HARD
# Tags: backtracklc, matrixlc, #52

# GIVEN:
    # an integer n

# TASK:
    # place n queens on an n x n chessboard such that no 2 queens attack each other
...
# EXAMPLES:
    ...
    # Explanation: 
        # Solution 1: [".Q..","...Q","Q...","..Q."]
        # Solution 2: ["..Q.","Q...","...Q",".Q.."]
        # There exist 2 distinct solutions to the 4-queens puzzle as shown above
...
def solveNQueens(n):
    ...
    def backtrack(r): # r = row no.
        if r == n: # this means all rows have been completed -> result +1
            nonlocal result # result is declared outside this function
            result += 1 # add solution to return result
            return
